...
const Wrapper = (props) => (
  <div>
    ...
    <Trans render="h1">Hi from Page</Trans> <Trans render = "h1">Sipsiku World Tour</Trans>
    {console.log(props)}
    
  </div>)

class SipsikuPage extends React.Component {
  constructor(props) {
    super(props)
  }
  onLangChange = lang => {
...
export default withI18n()(SipsikuPage)